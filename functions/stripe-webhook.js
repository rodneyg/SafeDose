...
var require_utils2 = __commonJS({
  "node_modules/stripe/cjs/utils.js"(exports2) {
    ...
    function getDataFromArgs(args2) {
      if (!Array.isArray(args2) || !args2[0] || typeof args2[0] !== "object") {
        return {};
      }
      if (!isOptionsHash(args2[0])) {
        return args2.shift();
      }
      const argKeys = Object.keys(args2[0]);
    ...
    function getOptionsFromArgs(args2) {
      const opts = {
        host: null,
        headers: {},
        settings: {}
      ...
      if (args2.length > 0) {
        const arg = args2[args2.length - 1];
        if (typeof arg === "string") {
          opts.authenticator = createApiKeyAuthenticator(args2.pop());
        } else if (isOptionsHash(arg)) {
          const params = Object.assign({}, args2.pop());
    ...
    function protoExtend(sub) {
      const Super = this;
      const Constructor = Object.prototype.hasOwnProperty.call(sub, "constructor") ? sub.constructor : function(...args2) {
        Super.apply(this, args2);
      };
      ...
      _rawRequest(method, path, params, options) {
        const requestPromise = new Promise((resolve, reject) => {
          ...
          try {
            ...
            const args2 = [].slice.call([params, options]);
            const dataFromArgs = (0, utils_js_1.getDataFromArgs)(args2);
            const data = Object.assign({}, dataFromArgs);
            const calculatedOptions = (0, utils_js_1.getOptionsFromArgs)(args2);
...
var require_autoPagination = __commonJS({
  "node_modules/stripe/cjs/autoPagination.js"(exports2) {
    ...
    var makeAutoPaginationMethodsFromIterator = (iterator) => {
      const autoPagingEach = makeAutoPagingEach((...args2) => iterator.next(...args2));
    ...
    function getDoneCallback(args2) {
      if (args2.length < 2) {
        return null;
      }
      const onDone = args2[1];
      if (typeof onDone !== "function") {
        throw Error(`The second argument to autoPagingEach, if present, must be a callback function; received ${typeof onDone}`);
      }
      return onDone;
    }
    function getItemCallback(args2) {
      if (args2.length === 0) {
        return void 0;
      }
      const onItem = args2[0];
    ...
    function makeAutoPagingEach(asyncIteratorNext) {
      return function autoPagingEach() {
        ...
        const onItem = getItemCallback(args2);
        const onDone = getDoneCallback(args2);
        if (args2.length > 2) {
          throw Error(`autoPagingEach takes up to two arguments; received ${args2}`);
        }
    ...
    function isReverseIteration(requestArgs) {
      const args2 = [].slice.call(requestArgs);
      const dataFromArgs = (0, utils_js_1.getDataFromArgs)(args2);
  ...
  "node_modules/stripe/cjs/StripeMethod.js"(exports2) {
    ...
    function stripeMethod(spec) {
      ...
      return function(...args2) {
        const callback = typeof args2[args2.length - 1] == "function" && args2.pop();
        spec.urlParams = (0, utils_js_1.extractUrlParams)(spec.fullPath || this.createResourcePathWithSymbols(spec.path || ""));
        const requestPromise = (0, utils_js_1.callbackifyPromiseWithTimeout)(this._makeRequest(args2, spec, {}), callback);
        Object.assign(requestPromise, (0, autoPagination_js_1.makeAutoPaginationMethods)(this, args2, spec, requestPromise));
        return requestPromise;
      };
    }
  ...
  "node_modules/stripe/cjs/StripeResource.js"(exports2) {
    ...
    StripeResource.prototype = {
      ...
      _getRequestOpts(requestArgs, spec, overrideData) {
        ...
        const options = (0, utils_js_1.getOptionsFromArgs)(args2);
        const host = options.host || spec.host;
        const streaming = !!spec.streaming;
        if (args2.filter((x) => x != null).length) {
          throw new Error(`Stripe: Unknown arguments (${args2}). Did you mean to pass an options object? See https://github.com/stripe/stripe-node/wiki/Passing-Options. (on API request to ${requestMethod} \`${path}\`)`);
        }
...
var require_bytes = __commonJS({
  "node_modules/raw-body/node_modules/bytes/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/micro/dist/src/lib/index.js
var require_lib3 = __commonJS({
  "node_modules/micro/dist/src/lib/index.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.json = exports2.text = exports2.buffer = exports2.run = exports2.sendError = exports2.send = exports2.createError = exports2.HttpError = exports2.serve = void 0;
    var stream_1 = require("stream");
    var content_type_1 = __importDefault(require_content_type());
    var raw_body_1 = __importDefault(require_raw_body());
    function isStream(stream) {
      return stream !== null && typeof stream === "object" && stream instanceof stream_1.Stream && typeof stream.pipe === "function";
    }
    function readable(stream) {
      return isStream(stream) && stream instanceof stream_1.Readable && stream.readable;
    }
    var serve = (fn2) => (req, res) => (0, exports2.run)(req, res, fn2);
    exports2.serve = serve;
    ...
    var createError = (code, message2, original) => {
      const err = new HttpError(message2);
      err.statusCode = code;
      err.originalError = original;
      return err;
    };
    exports2.createError = createError;
    var send = (res, code, obj = null) => {
      res.statusCode = code;
      if (obj === null) {
        res.end();
        return;
    ...
    exports2.send = send;
    var sendError = (req, res, errorObj) => {
      if ("statusCode" in errorObj && errorObj.statusCode) {
        (0, exports2.send)(res, errorObj.statusCode, errorObj.message);
      } else
        (0, exports2.send)(res, 500, "Internal Server Error");
    ...
    var run = (req, res, fn2) => new Promise((resolve) => {
      resolve(fn2(req, res));
    }).then((val) => {
      if (val === null) {
        (0, exports2.send)(res, 204, null);
        return;
      }
      if (val !== void 0) {
        (0, exports2.send)(res, res.statusCode || 200, val);
      }
    }).catch((err) => {
      if (isError(err)) {
        (0, exports2.sendError)(req, res, err);
      }
    });
    exports2.run = run;
    var rawBodyMap = /* @__PURE__ */ new WeakMap();
    var parseJSON = (str) => {
      try {
        return JSON.parse(str);
      } catch (err) {
        throw (0, exports2.createError)(400, "Invalid JSON", err);
      }
    };
    function isRawBodyError(error) {
      return "type" in error;
    }
    var buffer2 = (req, { limit = "1mb", encoding } = {}) => Promise.resolve().then(() => {
      ...
      return (0, raw_body_1.default)(req, {
        ...
        if (isRawBodyError(err) && err.type === "entity.too.large") {
          throw (0, exports2.createError)(413, `Body exceeded ${limit} limit`, err);
        } else {
          throw (0, exports2.createError)(400, "Invalid body", err);
        }
      });
    });
    exports2.buffer = buffer2;
    var text = (req, { limit, encoding } = {}) => (0, exports2.buffer)(req, { limit, encoding }).then((body) => body.toString(encoding));
    exports2.text = text;
    var json = (req, opts = {}) => (0, exports2.text)(req, opts).then((body) => parseJSON(body));
    exports2.json = json;
  }
});
